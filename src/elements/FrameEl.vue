...
const showGuide = computed(
  () => !cms.state.preview && (props.element.styles.borderWidth ?? 0) === 0,
)
...
const showLayoutGuides = computed(
  () =>
    !cms.state.preview &&
    (isSelected.value || childSelected.value) &&
  ...
  <div :style="style">
    ...
    <template v-if="showLayoutGuides">
      <div
        v-if="pad.t > 0"
        class="pad-guide"
        :style="{ top: 0, left: 0, width: '100%', height: pad.t + 'px' }"
      />
      <div
        v-if="pad.r > 0"
        class="pad-guide"
        :style="{
          ...
          right: 0,
          width: pad.r + 'px',
          height: `calc(100% - ${pad.t + pad.b}px)`,
        }"
      />
      <div
        v-if="pad.b > 0"
        class="pad-guide"
        :style="{ bottom: 0, left: 0, width: '100%', height: pad.b + 'px' }"
      />
      <div
        v-if="pad.l > 0"
        class="pad-guide"
