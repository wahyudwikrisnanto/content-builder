...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'divider'">
      <path d="M3 12h18" />
      <path d="M3 6h18" opacity=".25" />
      <path d="M3 18h18" opacity=".25" />
    </template>
    ...
    <template v-else-if="name === 'list-number'">
      ...
      <text x="3" y="8" font-size="6" fill="currentColor" stroke="none" font-family="sans-serif">
        1
      </text>
      <text x="3" y="14" font-size="6" fill="currentColor" stroke="none" font-family="sans-serif">
        2
      </text>
      <text x="3" y="20" font-size="6" fill="currentColor" stroke="none" font-family="sans-serif">
        3
      </text>
    </template>
    ...
    <template v-else-if="name === 'align-top-edge'">
      ...
      <rect x="7" y="8" width="4" height="12" rx="1" />
