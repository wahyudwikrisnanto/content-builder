...
const title = computed(() =>
  props.format === 'json' ? 'Import JSON design' : 'Import CKEditor HTML',
)
const placeholder = computed(() =>
  props.format === 'json' ? 'Paste JSON here...' : 'Paste HTML markup here...',
)
const accept = computed(() =>
  props.format === 'json' ? '.json,application/json' : '.html,.htm,text/html',
)
